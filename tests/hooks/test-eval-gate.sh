...
echo '{"run_id":"test-run-9","boundary_tests":[]}' > "$TEST_DIR_BT/artifacts/runs/test-run-9/boundary-results.json"
echo '{"run_id":"test-run-9","manifest_path":"'"$TEST_DIR_BT"'/artifacts/runs/test-run-9/manifest.json","boundary_results_path":"'"$TEST_DIR_BT"'/artifacts/runs/test-run-9/boundary-results.json"}' > "$TEST_DIR_BT/.claude/current-run.json"
OUTPUT_BT="$(CLAUDE_PROJECT_DIR="$TEST_DIR_BT" bash "$PROJECT_DIR/hooks/scripts/codex-eval-gate.sh" 2>/dev/null || true)"
if echo "$OUTPUT_BT" | grep -q 'boundary tests not passed'; then
...
echo '{"run_id":"test-run-12","boundary_tests":[{"type":"integration-test","status":"PASS","exit_code":0,"log_sha256":"abc123"},{"type":"api-contract-test","status":"PASS","exit_code":0,"log_sha256":"def456"}]}' > "$TEST_DIR_BTR/artifacts/runs/test-run-12/boundary-results.json"
echo '{"run_id":"test-run-12","manifest_path":"'"$TEST_DIR_BTR"'/artifacts/runs/test-run-12/manifest.json","boundary_results_path":"'"$TEST_DIR_BTR"'/artifacts/runs/test-run-12/boundary-results.json"}' > "$TEST_DIR_BTR/.claude/current-run.json"
...
echo '{"run_id":"test-run-14","boundary_tests":[{"type":"integration-test","status":"PASS","exit_code":0,"log_sha256":"ghi789"}]}' > "$TEST_DIR_BTP/artifacts/runs/test-run-14/boundary-results.json"
echo '{"run_id":"test-run-14","manifest_path":"'"$TEST_DIR_BTP"'/artifacts/runs/test-run-14/manifest.json","boundary_results_path":"'"$TEST_DIR_BTP"'/artifacts/runs/test-run-14/boundary-results.json"}' > "$TEST_DIR_BTP/.claude/current-run.json"
...
echo '{"run_id":"test-run-16","boundary_tests":[{"type":"integration-test","status":"PASS","exit_code":0,"log_sha256":"jkl012"},{"type":"api-contract-test","status":"PASS","exit_code":0,"log_sha256":"mno345"}]}' > "$TEST_DIR_BTX/artifacts/runs/test-run-16/boundary-results.json"
echo '{"run_id":"test-run-16","manifest_path":"'"$TEST_DIR_BTX"'/artifacts/runs/test-run-16/manifest.json","boundary_results_path":"'"$TEST_DIR_BTX"'/artifacts/runs/test-run-16/boundary-results.json"}' > "$TEST_DIR_BTX/.claude/current-run.json"
...
echo '{"run_id":"test-run-18","boundary_tests":[{"type":"integration-test","status":"PASS","exit_code":0,"log_sha256":"pqr678"}]}' > "$TEST_DIR_ATTEST/artifacts/runs/test-run-18/boundary-results.json"
echo '{"run_id":"test-run-18","manifest_path":"'"$TEST_DIR_ATTEST"'/artifacts/runs/test-run-18/manifest.json","boundary_results_path":"'"$TEST_DIR_ATTEST"'/artifacts/runs/test-run-18/boundary-results.json"}' > "$TEST_DIR_ATTEST/.claude/current-run.json"
...
echo '{"run_id":"test-run-22","boundary_tests":[{"type":"integration-test","status":"FAIL","exit_code":0,"log_sha256":"stu901"}]}' > "$TEST_DIR_FAIL0/artifacts/runs/run-f0/boundary-results.json"
echo '{"run_id":"test-run-22","manifest_path":"'"$TEST_DIR_FAIL0"'/artifacts/runs/run-f0/manifest.json","boundary_results_path":"'"$TEST_DIR_FAIL0"'/artifacts/runs/run-f0/boundary-results.json"}' > "$TEST_DIR_FAIL0/.claude/current-run.json"
...
if echo "$OUTPUT_F0" | grep -q 'boundary tests not passed'; then
...
echo '{"run_id":"test-run-23","boundary_tests":[{"type":"lint-check","status":"PASS","exit_code":0,"log_sha256":"vwx234"}]}' > "$TEST_DIR_NOFB/artifacts/runs/run-nofb/boundary-results.json"
echo '{"run_id":"test-run-23","manifest_path":"'"$TEST_DIR_NOFB"'/artifacts/runs/run-nofb/manifest.json","boundary_results_path":"'"$TEST_DIR_NOFB"'/artifacts/runs/run-nofb/boundary-results.json"}' > "$TEST_DIR_NOFB/.claude/current-run.json"
...
if echo "$OUTPUT_NOFB" | grep -q 'boundary tests not passed' && echo "$OUTPUT_NOFB" | grep -q 'source: boundary-results.json run test-run-23'; then
